<div data-custom-class="body">
		...
		<span style="color: rgb(127, 127, 127);">
			<span style="color: rgb(89, 89, 89); font-size: 15px;">
				...
				<span data-custom-class="body_text"
					...
					information when you use our services (<bdt class="block-component" />"<strong
						>Services</strong
			...
			<span style="font-size: 15px; color: rgb(89, 89, 89);">
				<span style="font-size: 15px; color: rgb(89, 89, 89);">
					<span data-custom-class="body_text"
						...
						events<span style="font-size: 15px;">
							<span style="color: rgb(89, 89, 89);">
								<span data-custom-class="body_text">
									<span style="font-size: 15px;">
										<span style="color: rgb(89, 89, 89);">
			...
			<span data-custom-class="body_text">
				<strong>
					<em
						...
						you are looking for. You can also click
					</em>
				</strong>
			</span>
		</span>
	...
	<div style="line-height: 1.5;">
		<span style="font-size: 15px;">
			<span data-custom-class="body_text">
				...
				interact with <bdt class="block-component" />
				<bdt class="question">Haja</bdt>
				<bdt class="statement-end-if-in-editor" /> and the Services, the choices you make, and
	...
	<div style="line-height: 1.5;">
		<span style="font-size: 15px;">
			<span data-custom-class="body_text">
				<strong
					>In what situations and with which <bdt class="block-component" />parties do we
		...
		<span style="font-size: 15px; color: rgb(89, 89, 89);">
			<span style="font-size: 15px; color: rgb(89, 89, 89);">
				<span data-custom-class="body_text">
					...
					<bdt class="block-component" />"<bdt class="statement-end-if-in-editor" />
					<span style="font-size: 15px;">
						<span data-custom-class="body_text">
							<span style="font-size: 15px;">
								<span style="color: rgb(89, 89, 89);">
						...
						<span style="font-size: 15px; color: rgb(89, 89, 89);">
							<span style="font-size: 15px; color: rgb(89, 89, 89);">
								<span data-custom-class="body_text">
									...
									</strong>We may process your information so you can create and
									...
									<span style="font-size: 15px; color: rgb(89, 89, 89);">
										<span data-custom-class="body_text">
											<strong
												...
												users.
											</strong>We may process your information to respond to
											your inquiries and solve any potential issues you might
											have with the requested service.<span
