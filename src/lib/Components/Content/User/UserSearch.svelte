...
<div class="w-full">
	<div class="relative">
		...
		<input
			class="block w-full p-4 pl-10 text-sm rounded-t-md text-gray-900 border border-gray-300 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
