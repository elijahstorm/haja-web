import{S as u,i as y,s as S,k as b,l as z,m as v,h as r,n as f,a7 as _,b as j,A as d}from"./index-1ec07f8a.js";function k(n){let t,l;return{c(){t=b("div"),this.h()},l(i){t=z(i,"DIV",{class:!0,style:!0}),v(t).forEach(r),this.h()},h(){f(t,"class",l=_(n[0])+" svelte-1qtja1k"),f(t,"style",n[1])},m(i,s){j(i,t,s)},p(i,[s]){s&1&&l!==(l=_(i[0])+" svelte-1qtja1k")&&f(t,"class",l)},i:d,o:d,d(i){i&&r(t)}}}function q(n,t,l){let{loadingStyle:i="circle"}=t,{size:s=3}=t,{left:a=0}=t,{top:o=0}=t,{right:m=0}=t,{bototm:c=0}=t,h=i=="dots"?"10px":`${s-.9}rem`;const g=`
		width: ${h};
		height: ${h};
		left: ${a}rem;
		top: ${o}rem;
