	...
	<div class="container">
		...
		>
			<div class="flex flex-col justify-between lg:justify-self-start lg:col-span-3">
				<img class="mb-7" src="images/logo-white.svg" alt="easybank logo" />
			...
			>
				<a class="hover:text-green-400" href="#About"> About Us </a>
				<a class="hover:text-green-400" href="#Contact"> Contact </a>
				<a class="hover:text-green-400" href="#Blog"> Blog </a>
				<a class="hover:text-green-400" href="#Careers"> Careers </a>
				<a class="hover:text-green-400" href="#Support"> Support </a>
				<a class="hover:text-green-400" href="#Privacy"> Privacy Policy </a>
			</div>
